...
<head>
    ...
    <script>
        ...
        if (!decodeURIComponent((new RegExp(";\\s*"+encodeURIComponent("px-demo-theme")+"\\s*=\\s*([^;]+)\\s*;","g").exec(";"+document.cookie+";")||[])[1])) {
            document.cookie = "px-demo-theme=clean";
        }
    </script>
...
<?php
// Pre-fetch data to avoid undefined variable errors and improve logic separation
$rows_received = [];
$rows_missing = [];
$array_rtu = [];
$array_rtu_result = [];
        ...
        <div class="panel-heading">
            <div class="row">
                ...
                <div class="col-md-4 text-md-right">
                    <a target="_blank" href="export_index.php" class="btn btn-primary btn-sm"><i class="fa fa-download"></i> Esporta</a>
                </div>
            </div>
        </div>
